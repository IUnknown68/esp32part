...
})(exports.PartitionSize || (exports.PartitionSize = {}));
...
class PartitionTable {
    static fromCsv(csv, maxSize = exports.PartitionSize.S128Mb) {
        const table = new PartitionTable(maxSize);
        return table;
    }
    constructor(maxSize = exports.PartitionSize.S128Mb) {
...
exports.MAX_FLASHSIZE_MB = MAX_FLASHSIZE_MB;
exports.MAX_NAME_LEN = MAX_NAME_LEN;
exports.MAX_PARTITION_TABLE_LENGTH = MAX_PARTITION_TABLE_LENGTH;
exports.MIN_FLASHSIZE_MB = MIN_FLASHSIZE_MB;
exports.MIN_PARTITION_SIZE = MIN_PARTITION_SIZE;
